...
$toko= query("SELECT * FROM pembayaran");
                ...
                <h1 class="h3 mb-2 text-gray-800">Tabel</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body d-flex justify-content-end py-3">
                           <a href="add.php" class="btn btn-primary btn sm"><i class="fas fa-plus"></i> tambah</a>
                        </div>  
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?= $brg["id_pembayaran"]?>" class="btn btn-warning btn-sm">edit</a> |
                                                <a href="hapus.php?id=<?= $brg["id_pembayaran"]?>" onclick="return confirm('yakinkah?')" class="btn btn-danger btn-sm"> hapus</a>
                                            </td>
                                        </tr>
                                        <?php $i++?>
                                        <?php endforeach; ?>
