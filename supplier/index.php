...
$toko= query("SELECT * FROM supplier");
                                            ...
                                            <?php if (!empty($toko)) : ?>
                                                <?php foreach ($toko as $brg) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $brg["alamat"] ?></td>
                                                        <td>
                                                            <a href="edit.php?id=<?= $brg["id_supplier"] ?>" class="btn btn-warning btn-sm">edit</a> |
                                                            <a href="hapus.php?id=<?= $brg["id_supplier"] ?>" onclick="return confirm('yakinkah?')" class="btn btn-danger btn-sm"> hapus</a>
                                                        </td>
                                                    </tr>
                                                    <?php $i++; ?>
                                                <?php endforeach; ?>
