                                    ...
                                    <div class="card-body">
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_supplier" class="form-control" id="nama" placeholder="masukan nama supplier" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea type="text" class="form-control" id="stok" placeholder="alamat" name="alamat" required></textarea>
                                            </div>
