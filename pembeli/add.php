                                    ...
                                    <div class="card-body">
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_supplier" class="form-control" id="nama" placeholder="masukan nama supplier">
                                            </div>
                                            <div class="mb-3">
                                                <label for="harga" class="form-label">telp</label>
                                                <input type="text" name="no_telp" class="form-control" id="harga" placeholder="no telp">
                                            </div>
                                            <div class="mb-3">
                                                <label for="stok" class="form-label">alamat</label>
                                                <input type="text" class="form-control" id="stok" placeholder="alamat" name="alamat">
                                            </div>
