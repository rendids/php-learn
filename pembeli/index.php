...
$toko= query("SELECT * FROM pembeli");
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $brg["email"] ?></td>
                                            <!-- <td>
                                                <a href="edit.php?id=<?= $brg["id_pembeli"]?>" class="btn btn-warning btn-sm">edit</a> |
                                                <a href="hapus.php?id=<?= $brg["id_pembeli"]?>" onclick="return confirm('yakinkah?')" class="btn btn-danger btn-sm"> hapus</a>
                                            </td> -->
                                        </tr>
                                        <?php $i++?>
                                        <?php endforeach; ?>
