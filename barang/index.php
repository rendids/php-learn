                            ...
                            <div class="table-responsive text-center">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><img src="images/<?= $brg["images"];  ?>" width="70"></td>
                                            <td><?= $brg["nama_barang"] ?></td>
                                            <td>Rp.<?= $brg["harga"] ?></td>
                                            <td>Tersisa:<?= $brg["stok"] ?></td>
                                            <td><?= $brg["nama_supplier"] ?></td>
                                            <td>
                                                <a href="edit.php?id=<?= $brg["id_barang"]?>" class="btn btn-warning btn-sm">edit</a> |
                                                <a href="hapus.php?id=<?= $brg["id_barang"]?>" onclick="return confirm('yakinkah?')" class="btn btn-danger btn-sm"> hapus</a>
                                            </td>
                                        </tr>
                                        <?php $i++?>
                                        <?php endforeach; ?>
