...
$toko= query("SELECT * FROM transaksi");
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?= $brg["id_transaksi"]?>" class="btn btn-warning btn-sm">edit</a> |
                                                <a href="hapus.php?id=<?= $brg["id_transaksi"]?>" onclick="return confirm('yakinkah?')" class="btn btn-danger btn-sm"> hapus</a>
                                            </td>
                                        </tr>
                                        <?php $i++?>
                                        <?php endforeach; ?>
